...
enum class VigAppScreen(@StringRes val title: Int) {
    ...
    //Todo falta faltan pantalla confuguaración y ver registros
}
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(route = VigAppScreen.Fichar.name) {
                FicharScreen(
                    onFichartButtonClicked = { navController.popBackStack(VigAppScreen.Menu.name, inclusive = false) },
                    onCancelButtonClicked = { navController.popBackStack(VigAppScreen.Menu.name, inclusive = false) })
            }
            ...
            composable(route = VigAppScreen.Registros.name) {
                RegistrosScreen(onHechoButtonClicked = { navController.popBackStack(VigAppScreen.Menu.name, inclusive = false) })
